# Data – Datenbasis, Variablen & Domänenmodell

> Übersicht über die Datenstruktur und eine kompakte Ontologie für LLM-Kontext.

## Ontologie (vereinfacht)

ENTITY Person
- id :: string
- name :: string
- canonical_role :: enum[artist, curator, researcher, organiser, other]

ENTITY Project
- id :: string
- title :: string
- type :: enum[exhibition, festival, workshop, publication, other]
- start_year :: int?
- end_year :: int?
...
RELATION collaborates_with (Person ↔ Person)
- derived_from :: shared_projects
- strength :: int (number of shared projects)

---

## Original Website-Inhalte zur Datenbasis (1:1)
...
<h2>Überblick</h2>
<p>Aufbau der Datenbasis aus öffentlich zugänglichen und unveröffentlichten Materialien des Vereins RHIZOM. 
Heterogene Formate (Word, PDF, HTML, Bilder) werden kombiniert, semi-automatisch strukturiert und um Metadaten ergänzt.</p>

<h2>Entitäten &amp; Relationen</h2>
<ul>
  <li>Personen (Rollen, Namensvarianten, aktive Zeiten)</li>
  <li>Projekte (Typen, Themen, Zeiträume)</li>
  <li>Orte (Veranstaltungsorte, Städte, Länder)</li>
</ul>

<h2>Nächste Schritte</h2>
<ol>
  <li>Normalisierung &amp; ID-Vergabe</li>
  <li>Mapping Personen ↔ Projekte</li>
  <li>Edges-Generierung für Netzwerkanalyse</li>
</ol>
