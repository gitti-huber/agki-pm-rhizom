# UserStories – Funktionale Anforderungen

> User Stories für zentrale Rollen (Forschende, RHIZOM-Mitglieder, interessierte Öffentlichkeit).

## Personas

- **P1 – Kulturforscher:in**  
- **P2 – RHIZOM-Mitglied / Kurator:in**  
- **P3 – Kulturpolitik / Fördergeber:in**  
- **P4 – Öffentliche Interessierte / Studierende**  

---

## User Stories (Auszug)

- _As a_ **researcher of cultural networks**, _I want to_ see an **overview graph** of Personen und Projekte, _so that I can_ Muster der Zusammenarbeit erkennen.
- _As a_ **RHIZOM member**, _I want to_ search for my **own name** und meine Projekte hervorheben, _so that I can_ meine Position im Netzwerk sehen.
- _As a_ **viewer**, _I want to_ filter nach **Zeitraum, Rolle und Projekttyp**, _so that I can_ gezielt bestimmte Facetten des Netzwerks erkunden.
- _As a_ **student**, _I want to_ read short explanations of **network analysis concepts**, _so that I can_ die Visualisierung besser verstehen.

---

## Original Website-Inhalte zur Visualisierung (1:1)
...
<head>
  <meta charset="utf-8" />
  <title>05 Visualisierung</title>
  <link rel="stylesheet" href="../assets/css/styles.css">
</head>
<body>
  <article>
    <h1>05 Visualisierung</h1>
    <p class="meta">Stand: 30. October 2025</p>
    
<h2>Interaktive Darstellung</h2>
<p>Ziel ist eine Webvisualisierung (z. B. D3.js oder pyvis via HTML-Export), mit Filterung nach Jahr, Rolle, Projekttyp.</p>
